...
# whatsmeow é um fork local (replace go.mau.fi/whatsmeow => ./whatsmeow-lib no go.mod) —
# precisa estar no contexto antes do download pra o `go mod download` resolver o replace.
